# -*- coding: utf-8 -*-
"""
Created on Wed May  5 23:37:57 2021
...
# Определение длины отрезков по координатам
...
# Определение площади треугольника по трем сторонам
...
# Функция для вычисления угла треугольника в градусах
...
# Проверка - возможно ли существование такого треугольника?
